...
OUTPUT_FILES = {
    "meta-llama/llama-4-scout": "base_in_counterfactual_results/base_in_counterfactual_inference_llama4_scout_part2.jsonl",
    "mistralai/mistral-small-3.2-24b-instruct": "base_in_counterfactual_results/base_in_counterfactual_inference_mistral_small_24b_part2.jsonl"
}
...
def main():
    ...
    half = len(pairs) // 2
    pairs = pairs[half:]  # Only process the second half of the pairs
    ...
    for model in MODELS:
        ...
        for pair_idx, pair in enumerate(pairs, start=half):
