...
OUTPUT_FILES = {
    "gemma3:4b": "base_in_counterfactual_results/base_in_counterfactual_inference_gemma3_4b_part2_2.jsonl"
...
def main():
    ...
    # Script B: Middle third of the second half
    pairs = second_half[chunk_size : 2 * chunk_size]
    start_index = half + chunk_size
