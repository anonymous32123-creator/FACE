...
OUTPUT_FILES = {
    "meta-llama/llama-4-scout": "counterfactual_results/counterfactual_inference_llama4_scout.jsonl",
    "mistralai/mistral-small-3.2-24b-instruct": "counterfactual_results/counterfactual_inference_mistral_small_24b.jsonl"
}
