...
# MODELS = ["gemma3:4b", "gemma3:12b", "llava:7b", "minicpm-v:8b"]
MODELS = ["gemma3:4b", "gemma3:12b"]

# Dictionary mapping each model to its specific output file
OUTPUT_FILES = {
    "gemma3:4b": "base_results/base_inference_gemma3_4b.jsonl",
    "gemma3:12b": "base_results/base_inference_gemma3_12b.jsonl"
}
