...
OUTPUT_FILES = {
    "gemma3:4b": "base_in_counterfactual_results/base_in_counterfactual_inference_gemma3_4b_part2_3.jsonl"
    # "gemma3:12b": "base_in_counterfactual_results/base_in_counterfactual_inference_gemma3_12b.jsonl"
}
...
def main():
    ...
    chunk_size = len(second_half) // 3

    # Script C: Final third of the second half (grabs everything remaining)
    pairs = second_half[2 * chunk_size :]
    start_index = half + (2 * chunk_size)
    ...
    for model in MODELS:
        ...
        for pair_idx, pair in enumerate(pairs, start=start_index):
